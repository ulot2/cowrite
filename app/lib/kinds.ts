...
export const kinds = {
  ...
  comments: { label: 'Comments', hint: 'Someone comments in a document you are in', types: ['commented'] },
  ...
  review: { label: 'Review and suggestions', hint: 'Status changes, and suggestions accepted or rejected', types: ['status', 'suggestion'] },
