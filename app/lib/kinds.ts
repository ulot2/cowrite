...
export const kinds = {
  ...
  review: { label: 'Review, suggestions, and decisions', hint: 'Status changes, section sign-offs and concerns, suggestions accepted or rejected, and decisions made or replaced', types: ['status', 'signoff', 'suggestion', 'decision'] },
