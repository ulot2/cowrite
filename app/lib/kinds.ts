...
export const kinds = {
  edits: { label: 'Edits and changes', hint: 'Someone edits, renames, creates, moves, restores, or deletes a document, or adds an idea', types: ['edited', 'renamed', 'created', 'moved', 'deleted', 'version', 'restored', 'idea'] },
  ...
  review: { label: 'Review, suggestions, and decisions', hint: 'Status changes, section sign-offs and concerns, suggestions accepted or rejected, and decisions made or replaced', types: ['status', 'signoff', 'check', 'suggestion', 'decision'] },
