...
- Suggestions: insertions on the accent wash with an accent underline, deletions struck on the warning wash, changed formatting with a dotted underline. A quiet bar above the text says how many suggestions there are and, while the cursor is in one, who made it, with Accept and Reject; otherwise Accept all and Reject all.
