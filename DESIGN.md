...
- AI panel: the side panel, opened by the sparkle tool. Two labelled groups (Selected text, Whole document) of bordered command buttons with a sparkle in the accent; the running one shows the spinner, the others wait. The AI's answers are ordinary suggestions and read "Suggested by AI". In comments, AI is the last name in the @ list and replies as "CoWrite AI".
